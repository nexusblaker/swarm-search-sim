    ...
    def generate_run_report(self, run_record: dict[str, Any], events: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        return self._register_report(
            ...
            summary_json={
                ...
                "confidence_summary": run_record["summary_json"].get("confidence_summary", {}),
                "feasibility_summary": run_record["summary_json"].get("feasibility_summary", {}),
                "provenance_manifest": run_record["summary_json"].get("provenance_manifest", {}),
                "assumptions_summary": run_record["summary_json"].get("assumptions_summary"),
                "known_limitations_summary": run_record["summary_json"].get("known_limitations_summary"),
                "benchmark_context": run_record["summary_json"].get("benchmark_context", []),
            },
            run_id=run_record["id"],
        )
    ...
    def generate_review_report(self, review_record: dict[str, Any]) -> dict[str, Any]:
        ...
        return self._register_report(
            ...
            summary_json={
                ...
                "confidence_summary": review_record.get("summary_json", {}).get("confidence_summary", {}),
                "feasibility_summary": review_record.get("summary_json", {}).get("feasibility_summary", {}),
                "provenance_manifest": review_record.get("summary_json", {}).get("provenance_manifest", {}),
                "assumptions_summary": review_record.get("summary_json", {}).get("assumptions_summary"),
                "known_limitations_summary": review_record.get("summary_json", {}).get("known_limitations_summary"),
                "benchmark_context": review_record.get("summary_json", {}).get("benchmark_context", []),
            },
            run_id=review_record["run_id"],
        )
